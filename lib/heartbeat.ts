// Bootstrap served by /script/loader/juru.lua.
// Detects executor, gets HWID, validates key against /api/unlock.
// No heartbeat ping loop — execution is reported via Discord webhook instead.
